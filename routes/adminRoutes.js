...
router.post("/orders/:id/generate-link",     authMiddleware, generateSignLink); // ← جدید

// ── روت‌های عمومی امضا (بدون توکن — برای کارفرما) ────
router.get("/sign/:token",  getOrderByToken);        // ← جدید
router.post("/sign/:token", submitClientSignature);  // ← جدید
